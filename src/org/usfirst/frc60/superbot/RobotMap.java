...
public class RobotMap {
    ...
    public static SpeedController fuelPickupSpeedController1;
    ...
    public static void init() {
        ...
        driveRightFront = new CANTalon(2);
        ...
        fuelPickupSpeedController1 = new Victor(0);
        LiveWindow.addActuator("FuelPickup", "Speed Controller 1", (Victor) fuelPickupSpeedController1);
