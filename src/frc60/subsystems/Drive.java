...
public class Drive extends Subsystem {
    ...
    private void magicSetLeftRev(double rev) {
    	leftBack.set(rev);
    	SmartDashboard.putString("LeftM", leftBack.getOutputVoltage() + " " + leftBack.getPosition() );
    }
    private void magicSetRightRev(double rev) {
    	rightBack.set(rev);
    	SmartDashboard.putString("RightM", rightBack.getOutputVoltage() + " " + rightBack.getPosition() );
    }
