...
public class GearCam extends Subsystem {
	...
	private void publishStats() {
		SmartDashboard.putString("Status", parts[0]);
		SmartDashboard.putString("X", parts[1]);
		SmartDashboard.putString("Y", parts[2]);
		SmartDashboard.putString("Width", parts[3]);
		SmartDashboard.putString("Height", parts[4]);
		SmartDashboard.putNumber("Angle", (Integer.parseInt(parts[1])-339.5)*degreesPerPixel);
	}
	public double angle() {
		return (Integer.parseInt(parts[1])-339.5)*degreesPerPixel;
	}
